ViewSettings = {
	Cockpit = {
	[1] = {-- player slot 1
		--CockpitLocalPoint      = {3.077,	0.574,	0},--Cockpit nach = vorne,hoch 4.705000,1.336000,0.000000
		CameraViewAngleLimits  = {60.000000,160.000000},
		CameraAngleRestriction = {false,90.000000,0.400000},
		CameraAngleLimits      = {160.000000,-75.000000,115.000000},--Kopf drehen = links rechts,runter,hoch
		--EyePoint               = {0.050000,0.000000,0.000000},--front/back,up/down,left/right}<-'neck dimension'in meters 
		limits_6DOF            = {x = {0.030000,0.400000},y ={-0.300000,0.100000},z = {-0.300000,2.300000},roll = 90.000000},--Bewegen = hinten vorne,oben unten,links rechts
		--ShoulderSize		   = 0.25,-- bewegt Körper, wenn Azimuth Wert mehr als 90 Grad
		Allow360rotation	   = false,
	},	
	}, -- Cockpit 
	Chase = {
		LocalPoint      = {0.0000,0.000,0.000000},
