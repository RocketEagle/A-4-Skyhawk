...
version		 = "1.5.3 (WIP)",	-- 	 
state		 = "installed",
info		 = _("The A-4 is a light weight, single engined attack aircraft. The A-4, in all its variants, has participated in a wide range of wars, like the Vietnam war and all the way up to the Falklands war. The A4 aircraft is designed primarily for the delivery of coventional and nuclear weapons during hours of daylight and under visual flight conditions. However, these aircraft also have the capability of delivering conventional ordinance, under the control of the TPQ-10 radar, using either manual or automatic release modes at night and during foul weather conditions."),
